...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "DELETE FROM taller WHERE id='$nombre'";
...
<body>
    <h2>Eliminar carro en taller</h2>
    <form method="post" action="eliminar_taller.php">
        <label for="id">ID del carro a eliminar:</label>
